...
The main purpose of this workflow is to compare multiple models coming out of ChromHMM. 
When running ChromHMM, we specify a number of states to detect. We generated data for 
four states up to 16 states. This workflow looks at how the states from each of these 
models correlates with gene expression. 

This workflow performes the following steps:
...
results.dir <- here("Results", "1.ChromHMM", form.states)
...
state.enrichment.file <- here("Results", "1.ChromHMM", form.states, "enrichment.by.state.RData")
```
