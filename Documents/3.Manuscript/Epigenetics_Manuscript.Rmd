...
[@lawrence2016lateral; @jones2012functions; @moore2013dna]. Across cell types, 
...
with relatively few cells [@pmid20077036], thus opening the door to the 
...
founders of the Diversity Outbred/Collaborative Cross (DO/CC) [@Svenson:2012hq]
mice, as well as DBA/2J, which, along with C57BL/6J, is one of the 
founders of the widely used BxD recombinant inbred panel of mice [@Ashbrook:2019bd]. 
We assayed four histone modifications (H3K4me1, H3K4me3, H3K27me3, 
and H3K27ac), as well as DNA methylation. We used ChromHMM [@Ernst:2012ii] 
...
were used immediately in ChIP assay. The ChIP assay was performed with
...
and indels from each strain, and the B6 samples were aligned directly 
to the reference mouse genome. The pseudogenomes were created using 
EMASE \url(https://github.com/churchill-lab/emase). We used Bowtie 
...
downloaded cCRE annotations provided by ENCODE [@pmid22955616] through the UCSC genome 
...
described above and in [@Svenson:2012hq]. We compared the 
effect of the imputed epigenetic features to imputed SNPs.
...
relative to gene bodies. For example, state `r nomark.state`, 
...
expression variation across strains, implying that although 
percent DNA methylation is used in gene regulation within a cell 
type, it is not heritable and does not contribute to variation 
in gene expression across genetically diverse individuals. 
...
and SNPs into a population of DO mice (Methods). Chromatin state is largely 
determined by local genotype, especially 
