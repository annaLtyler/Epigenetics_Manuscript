...
annotations <- c("heterochromatin", "active enhancer", "intragenic enhancer", 
    "active enhancer", "unknown", "active promoter", "unknown", "active enhancer",
    "repressor", "unknown", "unknown", "unknown", "bivalent promoter", "unknown", "poised enhancer",
    "unknown")
annotation.table <- cbind(binary_states, annotations)
