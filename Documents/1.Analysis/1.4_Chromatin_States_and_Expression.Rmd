...
pdf("~/Desktop/chromatin_state_abundance.pdf", width = 3, height = 10)
...
pdf("~/Desktop/chromatin_states_together.pdf", width = 7, height = 5.5)
plot.new()
...
mtext("Relative Gene Position", side = 1, line = 2.5, cex = 1.5)
mtext("Proportion Genes State Present", side = 2, line = 2.5, cex = 1.5)
dev.off()
```
