...
if(is.na(num.states)){
    ...
    #num.states = 10; delete.previous = FALSE
    #num.states = 11; delete.previous = FALSE
    #num.states = 14; delete.previous = FALSE
    num.states = 15; delete.previous = FALSE
    #num.states =16; delete.previous = FALSE
...
chrom.mats <- readRDS(get.files(path = results.dir,
    want = c("Chromatin_States", "full_gene_1000.RData"), full.names = TRUE))

#state ammount by strain
state.totals <- matrix(NA, nrow = num.states, ncol = 9)
rownames(state.totals) <- 1:num.states
...
pheatmap(log10(state.totals))
pheatmap(state.totals, scale = "row")
