...
ymin <- -0.6;ymax = 0.6
#state.col <- darken(colors.from.values(1:num.states, use.pheatmap.colors = TRUE), factor = 1.1)
#state.col <- unique(c(brewer.pal(9, "Set1"), brewer.pal(8, "Set2")))
#state.col = c('#e6194b', '#3cb44b', '#ffe119', '#4363d8', '#f58231', '#911eb4', '#46f0f0', '#f032e6', '#fabebe', '#008080', '#e6beff', '#9a6324', '#800000', '#808000', '#ffd8b1', '#000075', '#808080', '#000000')
state.col <- read.table(here("Data", "support_files", "state_colors.txt"), comment.char = "!")
