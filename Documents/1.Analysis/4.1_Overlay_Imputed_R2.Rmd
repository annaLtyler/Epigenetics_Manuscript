...
```{r r2_dist_fig}
pdf(here("Documents", "3.Manuscript", "Figures", "Variance_Explained_Distribution.pdf"),
width = 5, height = 5)
boxplot(r2.list[1:3], names = c("Haplotype", "Chromatin State", "SNP"),
cex.axis = 2)
dev.off()
```
...
The following plot shows data for Pkd2, which is has a very clean haplotype 
