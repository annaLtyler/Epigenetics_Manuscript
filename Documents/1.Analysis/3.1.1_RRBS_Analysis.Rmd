...
bimodal_effects <- cbind(rel.pos, all.lwr, all.fit, all.upr)
colnames(bimodal_effects) <- c("position", "lwr", "fit", "upr")
saveRDS(bimodal_effects, here("Results", "RRBS", "bimodal_effects.RDS"))
...
trimodal_effects <- cbind(rel.pos, all.lwr, all.fit, all.upr)
colnames(trimodal_effects) <- c("position", "lwr", "fit", "upr")
saveRDS(trimodal_effects, here("Results", "RRBS", "trimodal_effects.RDS"))
